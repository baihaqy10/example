pipeline {
    ...
    environment {
        ...
        OCP_API = "https://api.cluster-5l9jh.dynamic.redhatworkshops.io:6443"
        OCP_CREDENTIALS = "sha256~RsVpDz1TZ-oJju928Wvt1SA8b4WM_T261nEy-iaTD3U"  // sebaiknya pakai Jenkins Credentials, bukan hardcode
